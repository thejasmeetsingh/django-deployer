...
Revision ID: b4199297ad58
Revises: 
Create Date: 2024-05-03 06:57:40.038680
...
def upgrade() -> None:
    ...
    op.create_table('plans',
                    ...
                    sa.Column('created_at', sa.DateTime(), nullable=False),
                    sa.Column('modified_at', sa.DateTime(), nullable=False),
                    sa.Column('name', sa.Enum('LOW', 'MEDIUM', 'HIGH',
                                              name='plantype'), nullable=False),
